...
def cal_OMZ(index):
    ...
    area_shell = 'cdo -z zip -fldsum -mul {1}/{0}_omz_select_region.nc {3}/gr_area_soda342.nc {2}/{0}_omz_area.nc'.format(index, dst_path_20, dst_path_20_area, tool_path)
...
if __name__ == '__main__':
    ...
    #model_list = ['et_400_35_2_fit_GRIDDING_SODA342_2db_Indian.pkl', 'et_400_None_2_fit_GRIDDING_SODA342_2db_Indian.pkl', 'et_200_None_2_fit_GRIDDING_SODA342_2db_Indian.pkl']
    model_list = ['et_200_None_2_fit_GRIDDING_SODA342_2db_Indian.pkl']                      
