...
def model_predict(tup):
    ...
    region_path = 'sea_num_soda342_Indian_2023.nc'
    ...
    sea_region_list = (sea_region_ravel!=1) & (sea_region_ravel!=2) & (sea_region_ravel!=3) & (sea_region_ravel!=4)
    sea_region_nc.close()
    ...
    for monthIndex in range(0, 12):
        for depthIndex in range(0, 50):
            ...
            X_in = X_pred[judge_index[0],:]
            y_pred[judge_index[0]] = model.predict(X_in)
            y_pred[y_pred < 0] = 0
...
if __name__ == '__main__':
    ...
    #model_list = ['gbdt_fit_2db_Indian_train_index0.pkl','adaboost_fit_2db_Indian_train_index0.pkl']
    model_list = ['et_200_leaf20_fit_2db_Indian_train_2023.pkl']
