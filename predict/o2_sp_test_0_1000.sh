...
mkdir -p ${targetPath}/o2c_mmol_m-3_spatial_100/
mkdir -p ${targetPath}/o2c_mmol_m-3_spatial_400/
mkdir -p ${targetPath}/o2c_mmol_m-3_spatial_700/
...
do
        {
                ...
                cdo -z zip -expr,'o2c = o2_pred_rf * 1' -vertmean -sellevidx,1/22 -timmean ${file} ${targetPath}/o2c_μmol_kg-1_spatial_0_1200/${file_year}_o2c_spatial_0_1200.nc
