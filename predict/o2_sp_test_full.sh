...
#1000以上空间变化量 mol m-2
cdo -z zip -vertsum -sellevidx,1/22 ${targetPath}/o2_spatial_d.nc ${targetPath}/o2_spatial_0_1000.nc
#1000以下空间变化量 mol m-2
...
#1871-2010 1000以上趋势 mol m-2 year
...
#1980-2010 1000以上趋势 mol m-2 year
cdo -z zip -trend -selyear,1980/2010 ${targetPath}/o2_spatial_0_1000.nc ${targetPath}/o2_spatial_0_1000_trend_1980_a.nc ${targetPath}/o2_spatial_0_1000_trend_1980_b.nc &
...
#<1000米储量 Pmol
cdo -expr,'o2P = o2s/1000000000000000' -fldsum -mul ${targetPath}/o2_spatial_0_1000.nc gr_area.nc ${targetPath}/o2P_0_1000.nc &
#>1000米储量 Pmol
...
do
        {
                file_name=${file##*/}
                file_year=${file_name%%_*}
                cdo -z zip -expr,'o2c = o2_pred_rf * 1.027' -intlevel,100,400,700 -timmean ${file} ${targetPath}/o2c_mmol_m-3_spatial/${file_year}_o2c_spatial.nc
...
cdo -z zip -trend -selyear,1958/2010 ${targetPath}/o2c_mmol_m-3_spatial.nc ${targetPath}/o2c_mmol_m-3_spatial_trend_1958_a.nc ${targetPath}/o2c_mmol_m-3_spatial_trend_1958_b.nc &
