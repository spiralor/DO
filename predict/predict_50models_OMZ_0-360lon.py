...
def model_predict(tup):
    ...
    #for monthIndex in range(0, 12):
        for depthIndex in range(0, 40):
            ...
            X_pred = np.c_[_lon, _lat, _year, _month1, _depth, _u, _v, _w, _temp, _salt, _ssh, _taux, _tauy, _etop, _cmip6]
...
if __name__ == '__main__':
    ...
    model_list = ['et_400_None_fit_2db_f4_del1986_seed1_after1970_0-360lon.pkl','et_400_20_fit_2db_f4_del1986_seed1_after1970_0-360lon_lt20_sw100.pkl']
