...
def train(seed, all_data_path, file_name, work_log):
    ...
    model_estimate=ExtraTreesRegressor(random_state=seed, n_jobs=-1,n_estimators=400,max_depth=20)
...
if __name__ == '__main__':
    all_data_path = '~/do4/do_train/dataset/2db/2db_f4_del1986/GRIDDING_2db_f4_del1986_seed1_after1970.csv'
    
    file_name = 'et_400_20_fit_2db_f4_del1986_seed1_after1970_lt20_sw50'
