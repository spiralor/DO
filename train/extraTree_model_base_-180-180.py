...
def read_data(all_data_path):
    ...
    index = np.where(all_data_x[:,0] > 180)[0]
    all_data_x[index,0] = all_data_x[index,0] - 360
...
def train(seed, all_data_path, file_name, work_log):
    ...
    model_estimate=ExtraTreesRegressor(random_state=seed, n_jobs=-1,n_estimators=400,max_depth=None)
...
if __name__ == '__main__':
    ...
    file_name = 'et_400_None_fit_2db_f4_del1986_seed1_after1970_-180-180lon'
